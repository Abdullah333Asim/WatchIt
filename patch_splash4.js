...
const correctCode = `import { useState, useEffect } from "react";
          ...
          <div className="flex items-baseline">
            ...
            <div className="relative flex items-baseline">
              ...
              <motion.div
                ...
                initial={{ x: 130, rotate: 0, opacity: 1 }}
                animate={{ 
                  x: isAnim ? 0 : 130, 
                  rotate: isAnim ? -360 : 0, 
                  opacity: isAnim ? 0 : 1 
              ...
              >
                {/* Crossfade A -> a */}
                <motion.span className="absolute bottom-0 left-0 text-red-500" animate={{ opacity: isAnim ? 0 : 1 }} transition={{ duration: 0.6 }}>A</motion.span>
                <motion.span className="absolute bottom-0 left-0 text-white" animate={{ opacity: isAnim ? 1 : 0 }} transition={{ duration: 0.6 }}>a</motion.span>
              </motion.div>
            </div>
...
fs.writeFileSync('src/components/SplashAnimation.tsx', correctCode);
